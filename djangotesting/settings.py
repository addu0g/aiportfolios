...
SECRET_KEY = 'django-insecure-m8xf5t$#ammyp^w=9dv51d*lwot6ac1!ih5uut^e**pg-^r%il'
...
CORS_ORIGIN_WHITELIST = [
    'https://portfoliohelper-hnbec4ewh9dnanbg.canadaeast-01.azurewebsites.net,'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),
                 os.path.join(BASE_DIR, 'aiportfolios', 'templates', 'aiportfolios'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
